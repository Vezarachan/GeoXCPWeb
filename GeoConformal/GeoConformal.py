...
class GeoConformalSpatialPrediction:
    ...
    def compute_prediction_interval(self):
        """
        Calculate the confidence interval based on uncertainty
        Here is a little change for ConformalSHAP
        :return:
        """
        ...
        # upper_bound = self.y_test + self.geo_uncertainty
        # lower_bound = self.y_test - self.geo_uncertainty
    ...
    def analyze(self):
        ...
        self.compute_prediction_interval()
